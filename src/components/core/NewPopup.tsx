 ...
 */
const Popup: React.FC<PopupProps> = ({ title, content, onClose, actionButtonText = "OKAY", className = "" }) => {
    return (
        <div className={cn("flex flex-col h-full items-center bg-background-surface text-foreground-surface", className)}>
            ...
            >
                ...
                <div className="flex flex-col items-center lg:w-3/4">
                    <h2 className="text-heading-h2 font-semibold text-foreground-surface">{title}</h2>
                ...
                <div className="flex justify-center lg:justify-end lg:py-3 lg:px-5 ">
                    <motion.button
                        ...
                        className="w-full lg:w-[8rem] py-3 lg:py-1 
                            text-sm sm:text-foreground-link lg:text-white
